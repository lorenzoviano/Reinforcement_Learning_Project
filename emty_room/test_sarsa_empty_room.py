...
Runs on-policy TD control (SARSA) on the 5×5 EMPTY_ROOM.
...
plt.plot(episodes, cum_avg,
         label=f"SARSA (α={ALPHA:.2f}, ε={EPSILON:.2f})")
plt.title('SARSA on-policy TD Control: Cumulative Average Return')
plt.xlabel('Episode')
